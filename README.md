...
**TimesFM-X** is an analytical augmentation of TimesFM that introduces **Generative Memory (GVM)** and **Holographic Hyperdimensional Computing** to that aims to achieve sub-millisecond, scale-invariant forecasting.

### TimesFM-X Module Registry
| Module | Location | Description |
| :--- | :--- | :--- |
| **GVM Core** | `Generative_Memory/` | High-performance C-backend for Hilbert/VRNS synthesis. |
| **GVM Engine** | `src/timesfm/gvm_zs_engine.py` | Python bridge with Hybrid Acceleration & Vectorized Cache. |
| **HT Transformer** | `src/timesfm/holographic_transformer.py` | 2D Spatiotemporal Interference Attention engine. |
| **Spectral Sonar** | `src/timesfm/timesfm_x_core.py` | Koopman Lifting & Langevin Stability Gating. |
| **Pattern Registry** | `src/timesfm/timesfm_x_core.py` | FAISS-backed manifold shunting & induction. |

For more details architecture, see **[README_X.md]
